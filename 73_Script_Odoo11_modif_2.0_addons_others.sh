...
#sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/akretion/odoo-usability akretion-odoo-usability	# no se mantiene mas.
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/it-projects-llc/access-addons it-projects-llc-access-addons
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/it-projects-llc/mail-addons it-projects-llc-mail-addons
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/it-projects-llc/sync-addons it-projects-llc-sync-addons
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/it-projects-llc/website-addons it-projects-llc-website-addons
