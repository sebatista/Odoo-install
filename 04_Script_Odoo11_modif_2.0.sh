...
sudo su odoo -c "git clone --depth 1 --branch 11.0 --single-branch https://github.com/odoo/odoo odoo-server/"
sudo su odoo -c "pip3 install -r odoo-server/requirements.txt"
sudo su odoo -c "pip3 install -r odoo-server/doc/requirements.txt"