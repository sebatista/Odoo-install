...
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/account-closing account-closing
...
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/account-invoice-reporting account-invoice-reporting
...
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/account-reconcile account-reconcile
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/bank-payment bank-payment
...
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/credit-control credit-control
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/crm crm
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/currency currency
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/ddmrp ddmrp
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/donation donation
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/e-commerce e-commerce
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/event event
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/field-service field-service
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/geospatial geospatial
...
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/manufacture-reporting manufacture-reporting
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/margin-analysis margin-analysis
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/mis-builder mis-builder
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/multi-company multi-company
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/OpenUpgrade OpenUpgrade
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/operating-unit operating-unit
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/partner-contact partner-contact
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/pos pos
...
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/project project
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/project-reporting project-reporting
...
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/rma rma
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/sale-financial sale-financial
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/sale-reporting sale-reporting
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/sale-workflow sale-workflow
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/server-auth server-auth
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/server-backend server-backend
...
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/stock-logistics-barcode stock-logistics-barcode
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/stock-logistics-reporting stock-logistics-reporting
...
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/survey survey
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/timesheet timesheet
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/vertical-association vertical-association
sudo -H git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/vertical-hotel vertical-hotel
